...
const EN = {
  ...
  "savedViews.dateUnscheduled": "Unscheduled",
...
const ZH: Partial<typeof EN> = {
  ...
  "savedViews.clearDate": "清空时间",
  "savedViews.emptyHint": "设置过滤条件后可保存为视图。",
  "savedViews.date": "日期",
  "savedViews.dateAll": "全部日期",
  ...
  "savedViews.dateUnscheduled": "未排期",
