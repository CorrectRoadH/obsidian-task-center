...
const EN = {
  ...
  "savedViews.clearDate": "Clear schedule range",
  "savedViews.emptyHint": "Set filters, then save a new view.",
  "savedViews.date": "Schedule",
  "savedViews.dateAll": "All schedules",
  ...
  "savedViews.saveDisabled": "Set at least one filter before saving.",
  ...
  "savedViews.datePreset": "Schedule range",
  "savedViews.custom": "Custom",
  "savedViews.customDate": "Custom date",
  "savedViews.customRange": "Custom schedule range",
...
const ZH: Partial<typeof EN> = {
  ...
  "savedViews.clearDate": "清空排期范围",
  "savedViews.emptyHint": "设置过滤条件后可保存为视图。",
  "savedViews.date": "排期",
  "savedViews.dateAll": "全部排期",
